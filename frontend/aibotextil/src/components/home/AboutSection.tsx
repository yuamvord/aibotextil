        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-20 items-center">
          ...
          <div className="text-white space-y-6 animate-fade-in">
            ...
            <p className="text-lg md:text-xl font-light leading-relaxed text-gray-200">
              En <strong className="font-semibold text-white">Aibo Textil</strong> somos una empresa dedicada a la 
              comercialización de telas deportivas en Guatemala. Ofrecemos materiales 
              de la más alta calidad, con innovación tecnológica y sostenibilidad.
            </p>
            
            <p className="text-lg md:text-xl font-light leading-relaxed text-gray-200">
              Comprometidos en acercar al mercado local el mejor estándar internacional, 
              ayudando a marcas y confeccionistas a crear prendas de alto rendimiento.
            </p>

            {/* (Opcional) Botón de llamada a la acción */}
            <div className="pt-4">
               <button className="px-8 py-3 border border-white text-white hover:bg-white hover:text-black transition-all duration-300 font-medium tracking-wider uppercase rounded-sm">
                 Conocer más
               </button>
            </div>
          </div>
