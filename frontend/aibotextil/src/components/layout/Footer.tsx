    ...
    <footer className="bg-neutral-900 text-gray-300 font-light">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div className="space-y-6">
            ...
            <p className="text-sm leading-relaxed text-gray-400">
              Innovación textil para el alto rendimiento. 
              Comprometidos con la calidad y la sostenibilidad en cada fibra.
            </p>
          ...
          <div>
            <h3 className="text-white font-bold tracking-widest uppercase mb-6 text-sm">Empresa</h3>
          ...
          {/* COLUMNA 3: PRODUCTOS */}
          <div>
            <h3 className="text-white font-bold tracking-widest uppercase mb-6 text-sm">Catálogo</h3>
            <ul className="space-y-3 text-sm">
              <li>
          ...
          {/* COLUMNA 4: CONTACTO */}
          <div>
            <h3 className="text-white font-bold tracking-widest uppercase mb-6 text-sm">Contacto</h3>
            <ul className="space-y-4 text-sm">
              <li className="flex items-start gap-3">
                <MapPin size={18} className="text-aibo-red mt-1 shrink-0" />
                <span>
                  Ciudad de Guatemala, Guatemala.<br />
                  Zona 10, Edificio Textil.
                </span>
              </li>
              ...
              <li className="flex items-center gap-3">
                ...
                <a href="mailto:info@aibotextil.com" className="hover:text-white transition-colors">
                  info@aibotextil.com
                </a>
              </li>
            </ul>
      ...
      <div className="border-t border-neutral-800">
        <div className="container mx-auto px-6 py-6 flex flex-col md:flex-row justify-between items-center text-xs text-gray-500 gap-4">
          ...
          <p>&copy; {currentYear} Aibo Textil. Todos los derechos reservados.</p>
