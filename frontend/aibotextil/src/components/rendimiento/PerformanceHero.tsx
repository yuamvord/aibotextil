...
const PerformanceHero = () => {
  return (
    <section className="relative w-full h-[60vh] flex items-center overflow-hidden bg-black">
      ...
      {/* 1. IMAGEN DE FONDO (Corredor) */}
      <div className="absolute inset-0 z-0">
        <Image
          src="/images/hero-runner.png" // Imagen de corredor
          alt="Rendimiento Deportivo"
          fill
          className="object-cover opacity-60" // Un poco transparente para que se funda con el fondo negro
          priority
        />
        {/* Degradado rojo para darle el estilo del PDF */}
        <div className="absolute inset-0 bg-gradient-to-r from-aibo-red/90 via-aibo-red/40 to-transparent mix-blend-multiply"></div>
      </div>

      {/* 2. TEXTO CON ESTILO "SPORT" */}
      ...
      {/* Elementos decorativos (Líneas de velocidad) */}
